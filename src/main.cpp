...
Mat RenderFrame(ICamera& camera)
{
    ...
    CPrimDisc d1(RGB(1, 0, 1), Vec3f(-2, 1.7f, 0), Vec3f(0,1, 0), 2);
    ...
    std::vector<IPrim*> objetcs = {&s1, &s2, &s3, &t1, &t2, &p1, &d1};
...
int main(int argc, char* argv[])
{
    ...
    CCameraOrthographic cam4(resolution, Vec3f(-8, 3, 8), Vec3f(1, -0.1f, -1), Vec3f(1, 1, 0), 45);
